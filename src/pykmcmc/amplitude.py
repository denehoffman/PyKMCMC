...
class Amplitude:
    def __init__(self, g_rc, m_r, c_cc, m1_c, m2_c):
        ...
        self.res_rho_rc = jnp.sqrt(self.res_chi_plus_rc * self.res_chi_minus_rc)
    ...
    def pars_to_cx_beta_r(*pars):
        ...
        betas = jnp.array(
            [par_re + 1j * par_im for par_re, par_im in zip(pars[::2], pars[1::2])]
        )
        return betas
...
tree_util.register_pytree_node(
    Amplitude, Amplitude._tree_flatten, Amplitude._tree_unflatten
)
...
tree_util.register_pytree_node(
    AmplitudeS, AmplitudeS._tree_flatten, AmplitudeS._tree_unflatten
)


class AmplitudeAdlerS(AmplitudeS):
    def __init__(self, g_rc, m_r, c_cc, m1_c, m2_c, s_0, s_norm):
...
tree_util.register_pytree_node(
    AmplitudeAdlerS, AmplitudeAdlerS._tree_flatten, AmplitudeAdlerS._tree_unflatten
)
...
tree_util.register_pytree_node(
    AmplitudeD, AmplitudeD._tree_flatten, AmplitudeD._tree_unflatten
)
...
a0_g_rc = [[+0.43215, -0.28825], [+0.19000, +0.43372]]
a0_c_cc = [
    [+0.00000, +0.00000],
    [+0.00000, +0.00000],
]

a2_m1_c = [0.13498, 0.49368, 0.13498]
a2_m2_c = [0.54786, 0.49761, 0.95778]
a2_m_r = [1.30080, 1.75351]
a2_g_rc = [[+0.30073, +0.21426, -0.09162], [+0.68567, +0.12543, +0.00184]]
a2_c_cc = [
...
f0 = AmplitudeAdlerS(
    f0_g_rc, f0_m_r, f0_c_cc, f0_m1_c, f0_m2_c, s_0=0.0091125, s_norm=1.0
)
f2 = AmplitudeD(f2_g_rc, f2_m_r, f2_c_cc, f2_m1_c, f2_m2_c)
a0 = AmplitudeS(a0_g_rc, a0_m_r, a0_c_cc, a0_m1_c, a0_m2_c)
a2 = AmplitudeD(a2_g_rc, a2_m_r, a2_c_cc, a2_m1_c, a2_m2_c)
